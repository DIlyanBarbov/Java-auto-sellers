...
public class SellerForm extends JFrame {
	...
	public SellerForm() {
		...
		JLabel lblAddSeller = new JLabel("Add Seller");
		lblAddSeller.setForeground(Color.DARK_GRAY);
		lblAddSeller.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			int i= SellerDao.save(name, password, email, address, city, contact);
			if(i>0){
				JOptionPane.showMessageDialog(SellerForm.this,"Seller added successfully!");
				AdminSuccess.main(new String[]{});
				frame.dispose();
				
			}else{
				JOptionPane.showMessageDialog(SellerForm.this,"Sorry, unable to save!");
			}
			}
		});
